...
body, h1, h2, h3, h4, h5, h6, button, dd, dl, dt, fieldset, form, input,
	legend, li, ol, p, select, textarea, th, ul {
	margin: 0;
	padding: 0;
}
							...
							<div class="card-img" style="display: inline-block;">
								<c:forEach items="${list}" var="list" begin="0" end="0">
									<img class="card-img-top img-fluid"
										src="${pageContext.request.contextPath}/resources/brand/${list.brand_Img}.jpg"
							...
							<div class="card-header">
								...
								<c:if test="${loginUser.member_Type == '관리자' }">
									<div class="add" style="margin-top: 20px;">
										<input type="button" value="자동차추가"
											onclick="location.href='goodsAdd.do'" class="btn btn-primary">
									...
									<ul class='brandList imageLarge'>
										<c:forEach items="${list}" var="list">
											<ul class='modelList imageType clearFix'>
												<li code='3600' class='stock '><a onclick=""
													href="goodsDetail.do?b=${list.brand_Id}&c=${list.car_ID}"
													style="display: block;"> <img
														src="${pageContext.request.contextPath}/resources/${list.brand_Id}/${list.car_Img}.png">
