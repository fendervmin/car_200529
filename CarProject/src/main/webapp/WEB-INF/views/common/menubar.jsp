...
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/resources/css/mainView/common.css?after" type="text/css" 
...
<body>
	<div id="header" class="header" style="outline: none;">
		...
		<div class="contain" style="margin-top: 10px;">
			<dl class="hd_my">
				...
				<c:if
					...
					<dd>
						<a style="font-size: 12px;" style="font-size:15px"> ${ loginUser.member_Name }님
							환영합니다.</a>
					</dd>
					<dd class="arw">
		...
		<div class="hd_top" style="margin-top: 30px;">
			<a href="../">
				<img src="/resources/logo.jpg" style="width: 300px; heigth: 250px; margin-bottom:30px;">
			</a>
		</div>

		<div class="search" style="margin-bottom: 15px;">
			<form name="search" method="get" action="../goods/goodsSearch.do">
				<td><input type="text" style="width: 150px; heigth: 50px;"
					name="keyword"></td>
		...
		<div class="hd_gnb">
			...
			<ul id="menubar">
				...
				<li class="menubar_li" style="color: white;"><a
					href="../goods/goodsSales.do">판매실적</a></li>
